...
urlpatterns = [
    ...
    path('editown/<int:id>', views.editown, name='editown'),
    ...
    path('loghistory_pdf', views.loghistory_pdf, name='loghistory_pdf'),
    path('loguser_pdf', views.loguser_pdf, name='loguser_pdf'),
    path('loguser/', views.loguser, name='loguser'),
    path('trackuser/<str:username>', views.trackuser, name='trackuser'),
